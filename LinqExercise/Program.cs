...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var greaterThanSic = numbers.Where(num => num > 6);
            ...
            varoverTwentySix = employees.Where(emp => emp.Age > 26)
                > OrderBY(employees => emp.Age).ThenBy(emp => emp.FirstName);
            ...
            var avOfYOE = yoeEmployees.Average(emp => emp.YearsOfExperience);
            ...
            {
                Console.WriteLine($"{employees.FirstName} {emp.Age}");
            }
